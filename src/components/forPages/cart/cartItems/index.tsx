      ...
      <div>
         <div className="group/img flex flex-col justify-between xl:flex-row">
            ...
            <div className="flex gap-4 xl:w-4/5">
               <Link href={slug} className="size-[4.5rem] overflow-hidden rounded-none xl:size-36">
                  <Image
                     src={mainImage}
                     width={100}
                     height={100}
               ...
               <div className="flex flex-col justify-between">
                  <div className="flex flex-col gap-1 text-base">
                     <Link href={slug}>
                        <h3 className="text-lg font-medium capitalize xl:text-xl">{title}</h3>
                     </Link>
            ...
            <div className="flex flex-row-reverse items-center justify-between max-xl:mt-6 xl:w-1/5 xl:flex-col xl:items-end">
               <button onClick={() => dispatch(removeFromCartAction(id))} title="Remove From Cart">
                  <Image src={closeIcon} width={16} height={16} alt="Remove From Cart" className="size-4 opacity-80" />
               </button>
